...
import { Plan, PlanExerciseInterface, PlanModel, PlanMuscularGroupInterface } from "../../../../models/plan.model";
    ...
    async createPlan(newPlan: NewPlan, user: UserModel ): Promise<any>{
        ...
        for (let index = 0; index < newPlan.planExercises.length; index++) {
            ...
            if( foundPlanMuscularGroup ){
                ...
                const muscularGroup = await MuscularGroup.findById( exercise.muscularGroup ).lean();
